  ...
  <div class="bar-bg">
    <div class="bar-graph-wrap">
      ...
      <div class="bar-bottom clearFix">
        ...
        <!--</div>-->
        <div class="bar-cols  btn-div" style="float:right">
          <a href="/#/lineUp" class="enter-btn" v-if="btnState==-1||!userInfo">我要参与</a>
          <a class="reset-btn" v-else-if="btnState==2">买入中</a>
...
<style lang="scss" scoped>
  ...
  .bar-bg {
    background: url('./../assets/bg.png') center top repeat;
    .bar-graph-wrap {
      ...
      .curPrice {
        @include cr();
        @include sc(16px, #bababa);
        right: 20px;
        top: 50px;
        z-index: 9999;
        b {
          @include sc(30px, #ffffff)
        }
      }
      .bar-graph {
        width: 99.8%;
