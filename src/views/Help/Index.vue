  ...
  <div class="heipBoxer">
    ...
    <div class="helpTop">
      <div class="helpWrap">
        ...
        <div class="helpSch">
          <div class="helpInput">
            <el-input placeholder="请输入搜索关键词如“购票”" v-model="inp">
              <el-button slot="append" icon="el-icon-search" @click="$router.push('/HelpList?='+ inp)"></el-button>
            </el-input>
          </div>
          <div class="schItem">
            搜索热词：
    ...
    <div class="helpWrap">
      <h2>热门问题 </h2>
      <div class="hotTopics" @click="$router.push('/HelpList')">
        <div v-for='item in HelpHot' :key='item.id'>
          {{item.title}}
        </div>
    ...
    <div class="selfService">
      <div class="helpWrap">
        ...
        <div class="itemBox">
          ...
          <div @click="go('TelFind')">
            <img src="./../../assets/help2.png">
            <p>找回登录密码</p>
          </div>
          <div @click="go('AccountSet')">
            <img src="./../../assets/help3.png">
            <p>修改登录密码</p>
          </div>

          <div @click="go('TurnTicket')">
    ...
    <div class="helpWrap">
      ...
      <el-button type="primary" @click="$router.push('/ContactUs')" round style="width:140px;">联系我们</el-button>
    </div>
    <br/><br/><br/><br/><br/>
  </div>
</template>
...
<style lang="scss" scoped>
  .helpTop{padding:50px 0;background: url(./../../assets/bgbg.png) no-repeat center top;
