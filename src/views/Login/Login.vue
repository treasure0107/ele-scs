      ...
      <div class="register-form fl">
        ...
        <el-form :model="ruleForm" ref="ruleForm" class="form-pannel show">
          ...
          <el-form-item prop="password">
            <el-input auto-complete="new-password" v-model="ruleForm.LoginPwd" placeholder="密码"
...
<script type="text/babel">
  ...
  export default {
    ...
    mounted(){
      var self = this;
      if (self.$route.query.uname)
        self.ruleForm.Account = self.$route.query.uname;
                ...
                this.$message({
                  ...
                  onClose: () => {
                    if (window.localStorage) {
                      ...
                      this.$store.commit("getUserHead", imgBaseUrl + res.data.userinfo.avatar);
