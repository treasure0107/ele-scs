<template>
  <div class="register-wrap">
    <div class="container  clearFix">
      ...
      <div class="register-form fl">
        ...
        <div class="steps-wrap">
          ...
          <span index="2" ref="goSetPassword">2.设置登录密码</span>
        </div>
        <!--1.手机/邮箱验证-->
        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="form-pannel form-pannel"
          ...
          <div class="qq">
            <el-form-item v-show="strengthShow" class="qiang">
    ...
    <el-button type="primary" @click="loginBtn" class="login-btn">立即登录</el-button>
      ...
      <!--用户协议-->
      <el-dialog
        class="userAgreementContentMain"
...
//          alert(strs[1]);          //直接弹出第一个参数 （如果有多个参数 还要进行循环的）
      ...
      loginBtn(){
        ...
        this.$router.push('/login?uname='+this.ruleForm.Account);
      },
      //密码强度
      pwdStrong () {
...
<style>
  .userAgreementContentMain .el-dialog__title{
    font-size: 20px;
    font-weight: bold;
    color: rgb(35,42,74);
  }
